...
```{r glossary}
library(glossary)
glossary_path("files/glossary.yml")
glossary_popup("hover")
glossary_style(color = "yellow", 
               text_decoration = "underline",
               def_bg = "#333",
               def_color = "white")
```

This is a test to include the term `r glossary("alpha")` with a 
definition from the `glossary.yml` file.
